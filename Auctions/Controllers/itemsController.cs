...
namespace Auctions.Controllers
{
    public class itemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "iditem,name,minprice,price,category_idcategory,buy_now")] item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "iditem,name,minprice,price,category_idcategory,buy_now")] item item)
        {
            if (ModelState.IsValid)
            {
